...
<div class="editor-section">
  ...
  <div class="button-grid">
    <button data-sfx-hover="hover-soft" data-sfx-click="confirm" on:click={onSaveLocal}>Save Local Draft</button>
    <button data-sfx-hover="hover-emphasis" data-sfx-click="confirm" on:click={onOverwriteLevel}>Overwrite Disk Scene</button>
