...
export let stylePresets: Array<any> = []
...
export let styleSceneCandidates: Array<any> = []
...
export let onInspectAsset: () => void = () => {}
...
export let onUpdateBatchDescriptor: (
  candidateId: string,
  descriptor: string,
) => void = () => {}
</script>
...
{#if editorStyleStudioComponent}
  <svelte:component
    ...
    on:inspectAsset={onInspectAsset}
