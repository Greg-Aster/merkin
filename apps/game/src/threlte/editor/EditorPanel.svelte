<script lang="ts">
  ...
  import type { OutlinerDisplayMode, OutlinerNodeViewportState } from './editorOutlinerTypes'
  import {
  ...
  type EditorPanelTab = 'workflow' | 'scene' | 'environment' | 'player' | 'create' | 'hierarchy' | 'inspect' | 'style' | 'ai' | 'save'
  ...
  let outlinerExpandedIdsByMode: Record<OutlinerDisplayMode, string[]> = {
    ...
    'blender-file': ['outliner:blender-file:root', 'outliner:blender-file:scenes', 'outliner:blender-file:collections', 'outliner:blender-file:objects'],
    'data-api': ['outliner:data-api:root', 'outliner:data-api:scene', 'outliner:data-api:selection'],
  }
  ...
  function appendPipelineLog(message: string, detail?: unknown) {
    ...
    pipelineLogEntries = [`[${timestamp}] ${message}${suffix}`, ...pipelineLogEntries].slice(0, 400)
  }
  ...
  const levelController = createEditorLevelController({
    ...
    setMetadataState: (next) => {
      ...
      if (next.metadataDeployed !== undefined) metadataDeployed = next.metadataDeployed
      if (next.metadataStarMapEnabled !== undefined) metadataStarMapEnabled = next.metadataStarMapEnabled
      if (next.metadataStarMapYear !== undefined) metadataStarMapYear = next.metadataStarMapYear
      if (next.metadataStarMapDescription !== undefined) metadataStarMapDescription = next.metadataStarMapDescription
      if (next.metadataSourceKind !== undefined) metadataSourceKind = next.metadataSourceKind
      if (next.metadataSourceComponentKey !== undefined) metadataSourceComponentKey = next.metadataSourceComponentKey
      ...
      if (next.newLevelIdInput !== undefined) newLevelIdInput = next.newLevelIdInput
      if (next.newLevelTemplateId !== undefined) newLevelTemplateId = next.newLevelTemplateId
  ...
  const assetController = createEditorAssetController({
    state: {
      get assetBrowserPath() { return assetBrowserPath },
      set assetBrowserPath(value) { assetBrowserPath = value },
      get assetBrowserItems() { return assetBrowserItems },
      set assetBrowserItems(value) { assetBrowserItems = value },
      get assetBrowserFilter() { return assetBrowserFilter },
      set assetBrowserFilter(value) { assetBrowserFilter = value },
      get assetBrowserError() { return assetBrowserError },
      set assetBrowserError(value) { assetBrowserError = value },
      get assetBrowserLoading() { return assetBrowserLoading },
      set assetBrowserLoading(value) { assetBrowserLoading = value },
      get selectedLibraryItem() { return selectedLibraryItem },
      set selectedLibraryItem(value) { selectedLibraryItem = value },
      get textureBrowserPath() { return textureBrowserPath },
      set textureBrowserPath(value) { textureBrowserPath = value },
      get textureBrowserItems() { return textureBrowserItems },
      set textureBrowserItems(value) { textureBrowserItems = value },
      get textureBrowserError() { return textureBrowserError },
      set textureBrowserError(value) { textureBrowserError = value },
      get textureBrowserLoading() { return textureBrowserLoading },
      set textureBrowserLoading(value) { textureBrowserLoading = value },
      get workflowBrowserPath() { return workflowBrowserPath },
      set workflowBrowserPath(value) { workflowBrowserPath = value },
      get workflowBrowserItems() { return workflowBrowserItems },
      set workflowBrowserItems(value) { workflowBrowserItems = value },
      get workflowBrowserError() { return workflowBrowserError },
      set workflowBrowserError(value) { workflowBrowserError = value },
      get workflowBrowserLoading() { return workflowBrowserLoading },
      set workflowBrowserLoading(value) { workflowBrowserLoading = value },
      get selectedComfyWorkflowPath() { return selectedComfyWorkflowPath },
      set selectedComfyWorkflowPath(value) { selectedComfyWorkflowPath = value },
      get generatedVariantItems() { return generatedVariantItems },
      set generatedVariantItems(value) { generatedVariantItems = value },
      get generatedVariantLoading() { return generatedVariantLoading },
      set generatedVariantLoading(value) { generatedVariantLoading = value },
      get generatedVariantError() { return generatedVariantError },
      set generatedVariantError(value) { generatedVariantError = value },
      get selectedGeneratedVariantUrl() { return selectedGeneratedVariantUrl },
      set selectedGeneratedVariantUrl(value) { selectedGeneratedVariantUrl = value },
      get hunyuanStatus() { return hunyuanStatus },
      set hunyuanStatus(value) { hunyuanStatus = value },
      get hunyuanDetectedReferenceImageUrl() { return hunyuanDetectedReferenceImageUrl },
      set hunyuanDetectedReferenceImageUrl(value) { hunyuanDetectedReferenceImageUrl = value },
      get hunyuanReferenceImageUrl() { return hunyuanReferenceImageUrl },
      set hunyuanReferenceImageUrl(value) { hunyuanReferenceImageUrl = value },
      get hunyuanSupportsReplacement() { return hunyuanSupportsReplacement },
      set hunyuanSupportsReplacement(value) { hunyuanSupportsReplacement = value },
      get hunyuanSupportsTextureWrap() { return hunyuanSupportsTextureWrap },
      set hunyuanSupportsTextureWrap(value) { hunyuanSupportsTextureWrap = value },
      get hunyuanLastOutputUrl() { return hunyuanLastOutputUrl },
      set hunyuanLastOutputUrl(value) { hunyuanLastOutputUrl = value },
      get hunyuanLastResultSummary() { return hunyuanLastResultSummary },
      set hunyuanLastResultSummary(value) { hunyuanLastResultSummary = value },
      get hunyuanSelectionKey() { return hunyuanSelectionKey },
      set hunyuanSelectionKey(value) { hunyuanSelectionKey = value },
      get hunyuanInspectToken() { return hunyuanInspectToken },
      set hunyuanInspectToken(value) { hunyuanInspectToken = value },
    },
    ...
    getNodeTransformSnapshot: (node) => styleController?.getNodeTransformSnapshot(node) ?? null,
    readJsonPayload,
    setRuntimeDiagnostic,
    reportRuntimeAssetFailure,
    appendPipelineLog,
  ...
  styleController = createEditorStyleController({
    state: {
      get styleSelectionKey() { return styleSelectionKey },
      set styleSelectionKey(value) { styleSelectionKey = value },
      get styleProfileName() { return styleProfileName },
      set styleProfileName(value) { styleProfileName = value },
      get stylePrompt() { return stylePrompt },
      set stylePrompt(value) { stylePrompt = value },
      get styleNegativePrompt() { return styleNegativePrompt },
      set styleNegativePrompt(value) { styleNegativePrompt = value },
      get styleLoraNotes() { return styleLoraNotes },
      set styleLoraNotes(value) { styleLoraNotes = value },
      get styleControlNetNotes() { return styleControlNetNotes },
      set styleControlNetNotes(value) { styleControlNetNotes = value },
      get styleReferenceImageUrl() { return styleReferenceImageUrl },
      set styleReferenceImageUrl(value) { styleReferenceImageUrl = value },
      get styleStatus() { return styleStatus },
      set styleStatus(value) { styleStatus = value },
      get styleInspectReport() { return styleInspectReport },
      set styleInspectReport(value) { styleInspectReport = value },
      get styleSourceSummary() { return styleSourceSummary },
      set styleSourceSummary(value) { styleSourceSummary = value },
      get styleWorkspaceManifestUrl() { return styleWorkspaceManifestUrl },
      set styleWorkspaceManifestUrl(value) { styleWorkspaceManifestUrl = value },
      get styleWorkspaceSourceAssetUrl() { return styleWorkspaceSourceAssetUrl },
      set styleWorkspaceSourceAssetUrl(value) { styleWorkspaceSourceAssetUrl = value },
      get styleGeneratedReferenceImageUrl() { return styleGeneratedReferenceImageUrl },
      set styleGeneratedReferenceImageUrl(value) { styleGeneratedReferenceImageUrl = value },
      get styleSimplifiedAssetUrl() { return styleSimplifiedAssetUrl },
      set styleSimplifiedAssetUrl(value) { styleSimplifiedAssetUrl = value },
      get styleBlenderExportPath() { return styleBlenderExportPath },
      set styleBlenderExportPath(value) { styleBlenderExportPath = value },
      get styleBlenderOpenCommand() { return styleBlenderOpenCommand },
      set styleBlenderOpenCommand(value) { styleBlenderOpenCommand = value },
      get styleSimplifyRatio() { return styleSimplifyRatio },
      set styleSimplifyRatio(value) { styleSimplifyRatio = value },
      get styleSimplifyError() { return styleSimplifyError },
      set styleSimplifyError(value) { styleSimplifyError = value },
      get styleBusy() { return styleBusy },
      set styleBusy(value) { styleBusy = value },
      get styleWorkspaceRestoreToken() { return styleWorkspaceRestoreToken },
      set styleWorkspaceRestoreToken(value) { styleWorkspaceRestoreToken = value },
      get styleBatchBusy() { return styleBatchBusy },
      set styleBatchBusy(value) { styleBatchBusy = value },
      get styleBatchStatus() { return styleBatchStatus },
      set styleBatchStatus(value) { styleBatchStatus = value },
      get styleBatchAbortRequested() { return styleBatchAbortRequested },
      set styleBatchAbortRequested(value) { styleBatchAbortRequested = value },
      get styleBatchStopIntent() { return styleBatchStopIntent },
      set styleBatchStopIntent(value) { styleBatchStopIntent = value },
      get styleBatchSelectionIds() { return styleBatchSelectionIds },
      set styleBatchSelectionIds(value) { styleBatchSelectionIds = value },
      get styleBatchNodeStatusById() { return styleBatchNodeStatusById },
      set styleBatchNodeStatusById(value) { styleBatchNodeStatusById = value },
      get styleBatchSession() { return styleBatchSession },
      set styleBatchSession(value) { styleBatchSession = value },
      get styleBatchResumePromise() { return styleBatchResumePromise },
      set styleBatchResumePromise(value) { styleBatchResumePromise = value },
      get styleBatchPendingResume() { return styleBatchPendingResume },
      set styleBatchPendingResume(value) { styleBatchPendingResume = value },
      get comfyUiApiUrl() { return comfyUiApiUrl },
      set comfyUiApiUrl(value) { comfyUiApiUrl = value },
      get hunyuanApiUrl() { return hunyuanApiUrl },
      set hunyuanApiUrl(value) { hunyuanApiUrl = value },
      get selectedComfyWorkflowPath() { return selectedComfyWorkflowPath },
      set selectedComfyWorkflowPath(value) { selectedComfyWorkflowPath = value },
      get hunyuanPrompt() { return hunyuanPrompt },
      set hunyuanPrompt(value) { hunyuanPrompt = value },
      get hunyuanReferenceImageUrl() { return hunyuanReferenceImageUrl },
      set hunyuanReferenceImageUrl(value) { hunyuanReferenceImageUrl = value },
      get hunyuanLastOutputUrl() { return hunyuanLastOutputUrl },
      set hunyuanLastOutputUrl(value) { hunyuanLastOutputUrl = value },
      get hunyuanLastFitReport() { return hunyuanLastFitReport },
      set hunyuanLastFitReport(value) { hunyuanLastFitReport = value },
      get hunyuanActiveJobId() { return hunyuanActiveJobId },
      set hunyuanActiveJobId(value) { hunyuanActiveJobId = value },
      get hunyuanBackendCanGenerate() { return hunyuanBackendCanGenerate },
      set hunyuanBackendCanGenerate(value) { hunyuanBackendCanGenerate = value },
      get hunyuanBackendCanRetexture() { return hunyuanBackendCanRetexture },
      set hunyuanBackendCanRetexture(value) { hunyuanBackendCanRetexture = value },
      get hunyuanBackendStatus() { return hunyuanBackendStatus },
      set hunyuanBackendStatus(value) { hunyuanBackendStatus = value },
      get hunyuanBusy() { return hunyuanBusy },
      set hunyuanBusy(value) { hunyuanBusy = value },
      get hunyuanServiceReady() { return hunyuanServiceReady },
      set hunyuanServiceReady(value) { hunyuanServiceReady = value },
      get hunyuanDetectedReferenceImageUrl() { return hunyuanDetectedReferenceImageUrl },
      set hunyuanDetectedReferenceImageUrl(value) { hunyuanDetectedReferenceImageUrl = value },
      get selectedGeneratedVariantUrl() { return selectedGeneratedVariantUrl },
      set selectedGeneratedVariantUrl(value) { selectedGeneratedVariantUrl = value },
      get selectedHunyuanJobId() { return selectedHunyuanJobId },
      set selectedHunyuanJobId(value) { selectedHunyuanJobId = value },
      get saveMessage() { return saveMessage },
      set saveMessage(value) { saveMessage = value },
    },
    getSelectedNode: () => selectedNode,
    getSelectedNodes: () => selectedNodes,
    getEditorNodes: () => editorNodes,
    ...
    inspectSelectedAssetForHunyuan: assetController.inspectSelectedAssetForHunyuan,
    ...
    waitForQueuedHunyuanJob: (...args) => aiController.waitForQueuedHunyuanJob(...args),
    refreshHunyuanServiceStatus: (...args) => aiController.refreshHunyuanServiceStatus(...args),
    refreshHunyuanRecentJobs: () => aiController.refreshHunyuanRecentJobs(),
    runHunyuanForSelection: (...args) => aiController.runHunyuanForSelection(...args),
  })
  ...
  aiController = createEditorAiController({
    state: {
      ...
      get hunyuanReferenceImageUrl() { return hunyuanReferenceImageUrl },
      set hunyuanReferenceImageUrl(value) { hunyuanReferenceImageUrl = value },
      get hunyuanScratchName() { return hunyuanScratchName },
      set hunyuanScratchName(value) { hunyuanScratchName = value },
      get hunyuanScratchReferenceImageUrl() { return hunyuanScratchReferenceImageUrl },
      set hunyuanScratchReferenceImageUrl(value) { hunyuanScratchReferenceImageUrl = value },
      get hunyuanScratchPrompt() { return hunyuanScratchPrompt },
      set hunyuanScratchPrompt(value) { hunyuanScratchPrompt = value },
      get hunyuanLastFitReport() { return hunyuanLastFitReport },
      set hunyuanLastFitReport(value) { hunyuanLastFitReport = value },
      get hunyuanLastOutputUrl() { return hunyuanLastOutputUrl },
      set hunyuanLastOutputUrl(value) { hunyuanLastOutputUrl = value },
      ...
      get hunyuanActiveJobId() { return hunyuanActiveJobId },
      set hunyuanActiveJobId(value) { hunyuanActiveJobId = value },
      get hunyuanJobsLoading() { return hunyuanJobsLoading },
      set hunyuanJobsLoading(value) { hunyuanJobsLoading = value },
      get hunyuanJobsError() { return hunyuanJobsError },
      set hunyuanJobsError(value) { hunyuanJobsError = value },
      get recentHunyuanJobs() { return recentHunyuanJobs },
      set recentHunyuanJobs(value) { recentHunyuanJobs = value },
      get selectedHunyuanJobId() { return selectedHunyuanJobId },
      set selectedHunyuanJobId(value) { selectedHunyuanJobId = value },
      get comfyUiBusy() { return comfyUiBusy },
      set comfyUiBusy(value) { comfyUiBusy = value },
      get comfyUiReady() { return comfyUiReady },
      set comfyUiReady(value) { comfyUiReady = value },
      get comfyUiStatus() { return comfyUiStatus },
      set comfyUiStatus(value) { comfyUiStatus = value },
      get comfyWorkflowEditorStatus() { return comfyWorkflowEditorStatus },
      set comfyWorkflowEditorStatus(value) { comfyWorkflowEditorStatus = value },
      get saveMessage() { return saveMessage },
      set saveMessage(value) { saveMessage = value },
    },
    getSelectedNode: () => selectedNode,
  ...
  $: outlinerRows = flattenOutlinerItems(outlinerRootItems, hierarchyFilter, getOutlinerExpandedIds(outlinerExpandedIdsByMode, outlinerDisplayMode))
  $: outlinerVisibleNodeOrder = Array.from(new Set(outlinerRows.map((row) => row.nodeId).filter(Boolean) as string[]))
  ...
  $: selectedParentCandidates = editorNodes.filter((node) => node.id !== selectedNode?.id)
  $: multiSelectionParentCandidates = editorNodes.filter((node) => !selectedNodes.some((selected) => selected.id === node.id))
  ...
  $: assetPickerTargetName = editorNodes.find((node) => node.id === assetPickerTargetNodeId)?.name ?? ''
  $: canWorkflowShowAll = editorNodes.some((node) => !node.visible) || (editorState?.isolatedNodeIds.length ?? 0) > 0
  ...
  const observatoryStylePresets: EditorStylePreset[] = ['site', 'surreal-site', 'ghibli', 'alto', 'monument', 'retro']
  ...
  const stylePresetOptions = [
    {
      ...
      negativePrompt: '',
      loraNotes: 'Favor blackened, abyssal , violet-magenta rune glow, cosmic dread, monumental sacred architecture, and Norse myth gravitas over generic fantasy prettiness.',
      controlNetNotes: 'Preserve silhouette, traversal readability, climbability, collision anchors, route legibility, and the overwhelming mass of the world-tree. Keep emissive accents selective so the magenta and violet lights feel rare and ominous.',
    },
    {
      id: 'yggdrasil-sacred-natural',
      label: 'Yggdrasil · Sacred Mythic Natural',
      prompt: 'ancient sacred material language, weathered cosmic wood, rune-carved stone, moss, lichen, cold mist, restrained gold accents, monumental age, painterly but grounded, cohesive mythic surfaces, reverent atmosphere, carved history, readable forms',
      negativePrompt: '',
      loraNotes: 'Lean toward mythic Scandinavian sacred landscape and old ritual craft rather than generic high fantasy prettiness.',
      controlNetNotes: 'Preserve silhouette, climbability, collision readability, path readability, and landmark hierarchy.',
    },
    {
      id: 'painterly-storybook',
      label: 'Painterly Storybook',
      prompt: 'hand-painted storybook environment art, unified surface language, stylized materials, painterly wear, broad readable forms',
      negativePrompt: '',
      loraNotes: '',
      controlNetNotes: 'Preserve silhouette and major surface breakup from the source asset.',
    },
    {
      id: 'ruin-cathedral-neon',
      label: 'Ruin Cathedral · Neon Rune',
      prompt: 'dark ruin cathedral environment, sacred stone, fractured monoliths, magenta and cyan emissive rune channels, cold volumetric haze, monumental forms, restrained sci-fantasy glow, painterly surfaces',
      negativePrompt: '',
      loraNotes: 'Emphasize rune emissives and monumental ruin silhouettes.',
      controlNetNotes: 'Preserve landmark readability and broad architecture masses.',
    },
  ]
  ...
  const createQuickNodeActions = [
    ...
    { label: 'Light', action: () => createController.addPrimitivePrefab('light') },
    { label: 'Marker', action: () => createController.addPrimitivePrefab('marker') },
  ...
  $: if (activeSceneLevelId === 'yggdrasil' && styleLevelDefaultsAppliedFor !== activeSceneLevelId && !styleBatchSession) {
    ...
    stylePrompt = 'extremely dark cosmic horror material, blackened ancient, abyssal rune-carved, magenta and violet neon fissures, cold pink-purple emissive veins, starless depth, drowned shrine surfaces, monumental age, painterly but legible, strong silhouette hierarchy, selective luminous accents only, uncanny sacred dread'
    styleNegativePrompt = 'daylight, cheerful fantasy, bright saturated rainbow everywhere, literal tree branches replacing everything, photorealistic bark noise, modern clean architecture, sci-fi panels, plastic surfaces, glossy toy materials, cluttered microdetail, cozy forest, warm pastoral fantasy, cute bioluminescence'
    styleLoraNotes = 'Favor blackened, abyssal, violet-magenta rune glow, cosmic dread, and monumental sacred'
    styleControlNetNotes = 'Preserve silhouette, traversal readability, climbability, collision anchors, route legibility, and the overwhelming mass of the world-tree. Keep emissive accents selective so the magenta and violet lights feel rare and ominous.'
    styleBatchSelectionIds = getCuratedStyleBatchCandidateIds(activeSceneLevelId, editorNodes)
    styleBatchSelectionInitialized = true
  ...
  function applySolitudeAtmospherePreset(presetId: string | undefined) {
    ...
    updateLevelSceneSettings((settings) => {
      ...
      if (preset.settings.ambientParticles) {
        nextSettings.ambientParticles = structuredClone(preset.settings.ambientParticles)
      }

      nextSettings.features = {
        ...(nextSettings.features ?? {}),
        styles: preset.settings.style?.enabled ?? nextSettings.features?.styles ?? true,
        water: preset.settings.water?.enabled ?? nextSettings.features?.water ?? false,
        ambientParticles: preset.settings.ambientParticles?.enabled ?? nextSettings.features?.ambientParticles ?? true,
      }
  ...
  async function readJsonPayload(response: Response, context: string) {
    ...
    try {
      ...
      appendPipelineLog(`${context} returned non-JSON`, { status: response.status, preview })
      throw new Error(`${context} returned non-JSON data (${response.status}). ${preview}`)
    }
  }
  ...
  $: if (typeof window !== 'undefined') {
    window.localStorage.setItem(PIPELINE_LOG_ENABLED_STORAGE_KEY, pipelineLogEnabled ? '1' : '0')
    window.localStorage.setItem(PIPELINE_LOG_STORAGE_KEY, JSON.stringify(pipelineLogEntries))
  }
  ...
  $: selectedNodePreviewAssetUrl = assetController.getSelectedNodePreviewAssetUrl(selectedNode)
  ...
  $: {
    const nextGeneratedVariantKey = selectedNode?.id && selectedNode?.asset?.url?.startsWith('/generated/')
      ? `${selectedNode.id}:${selectedNode.asset.url}`
      : ''

    if (nextGeneratedVariantKey && nextGeneratedVariantKey !== generatedVariantSelectionKey) {
  ...
  $: {
    ...
    if (inspectionKey && inspectionKey !== lastInspectedHunyuanAsset) {
      ...
      void assetController.inspectSelectedAssetForHunyuan(nextAssetUrl, selectedNode?.id ?? '')
    ...
    if (nextStyleSelectionKey !== styleSelectionKey) {
      ...
      if (selectedNode && canUseStyleStudio(selectedNode)) {
        ...
        if (selectedNode.asset?.url) {
          void styleController.restoreLatestStyleWorkspaceForSelection(selectedNode.asset.url, selectedNode.id)
        }
      } else {
  ...
  onMount(() => {
    if (typeof window !== 'undefined') {
      ...
      pipelineLogEnabled = window.localStorage.getItem(PIPELINE_LOG_ENABLED_STORAGE_KEY) === '1'
      try {
    ...
    if (typeof window !== 'undefined') {
      ...
      if (persistedStyleBatch) {
        ...
        const hasOnlyTerminalEntries = persistedStyleBatch.entries.every((entry) => ['applied', 'failed', 'cancelled'].includes(entry.status))
  ...
  <div class="editor-shell" class:collapsed={!editorState.panelOpen}>
    ...
    {#if editorState.panelOpen}
      ...
      <EditorSavePanel
        ...
        onReloadDisk={reloadFromDisk}
        onResetDefault={resetToDefaultScene}
