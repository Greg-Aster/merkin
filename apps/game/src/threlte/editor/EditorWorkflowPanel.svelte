...
<div class="editor-section">
  ...
  <div class="tuple-group editor-mt-sm">
    <div class="tuple-label">Merge Descriptor</div>
    <input class="text-input" bind:value={mergeDescriptor} data-sfx-focus="focus-soft" placeholder="Describe the merged object for later reimagining" />
  </div>
  <div class="button-row compact editor-mt-sm">
  ...
  <div class="button-row compact editor-mt-sm">
    <button data-sfx-hover="hover-emphasis" data-sfx-click="confirm" on:click={onMergeSelectionToAsset} disabled={selectedNodes.length === 0}>Merge Selection To Asset</button>
  </div>
