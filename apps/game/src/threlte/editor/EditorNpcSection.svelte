...
{#if fireflyPresentation}
  <div class="editor-subsection">
    ...
    <div class="editor-field-grid editor-mt-sm">
      ...
      <label class="editor-field">
        <span class="editor-field-label">Sprite Intensity</span>
        <input
          class="tuple-input"
          type="number"
          min="0"
          step="0.05"
          value={fireflyPresentation.spriteIntensity}
          on:change={(event) =>
            onNpcChange({
              scope: 'presentationNumber',
              field: 'spriteIntensity',
              value: (event.currentTarget as HTMLInputElement).value,
            })}
        />
      </label>
      <label class="editor-field">
        <span class="editor-field-label">Light Intensity</span>
        <input
          class="tuple-input"
          type="number"
          min="0"
          step="0.05"
          value={fireflyPresentation.lightIntensity}
          on:change={(event) =>
            onNpcChange({
              scope: 'presentationNumber',
      ...
      <label class="editor-field">
        <span class="editor-field-label">Light Distance</span>
        <input
          class="tuple-input"
          type="number"
          min="0"
          step="0.1"
          value={fireflyPresentation.lightDistance}
          on:change={(event) =>
            onNpcChange({
              scope: 'presentationNumber',
              field: 'lightDistance',
      ...
      <label class="editor-field">
        <span class="editor-field-label">Light Decay</span>
        <input
          class="tuple-input"
          type="number"
          min="0"
          step="0.05"
          value={fireflyPresentation.lightDecay ?? 1.25}
          on:change={(event) =>
            onNpcChange({
              scope: 'presentationNumber',
              field: 'lightDecay',
