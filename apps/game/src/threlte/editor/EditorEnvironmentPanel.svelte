...
<div class="editor-section">
  ...
  <div class="tuple-group">
    ...
    <div class="editor-field-grid editor-field-grid--triple editor-mt-sm">
      ...
      <label class="editor-field"><span class="editor-field-label">Kuwahara Res</span><input class="tuple-input" type="number" step="0.05" min="0.35" max="1" value={levelSettings.renderProfile?.postProcessing?.kuwahara?.resolutionScale ?? 1} on:input={(event) => updateLevelNumericSetting(['renderProfile', 'postProcessing', 'kuwahara', 'resolutionScale'], (event.currentTarget as HTMLInputElement).value)} /></label>
    </div>
  </div>
