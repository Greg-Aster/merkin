...
const OBSERVATION_GALLERY_CENTER: Vector3Tuple = [
  -10.8,
  SECOND_DECK_Y + 0.8,
  8.4,
]
...
$: activeSkyboxPreset =
  SKYBOX_PRESETS[
    mirandaLevelSettings.skyboxPreset as keyof typeof SKYBOX_PRESETS
  ] ?? SKYBOX_PRESETS.observatory
$: effectivePlayerSpawnPoint =
  mirandaLevelSettings.spawn?.position ?? playerSpawnPoint
...
$: mirandaAmbientIntensity =
  mirandaLevelSettings.lighting?.ambientIntensity ?? 0.38
$: mirandaFillLightIntensity =
  mirandaLevelSettings.lighting?.fillLightIntensity ?? 0.42
$: mirandaKeyLightIntensity =
  mirandaLevelSettings.lighting?.keyLightIntensity ?? 1.15
...
const bunkStacks = [
  {
    id: 'bunk-port-a',
    position: [-7.55, FLOOR_Y + 0.76, -4.2] as Vector3Tuple,
  },
  { id: 'bunk-port-b', position: [-7.55, FLOOR_Y + 2.1, -4.2] as Vector3Tuple },
  {
    id: 'bunk-starboard-a',
    position: [-7.55, FLOOR_Y + 0.76, 0.9] as Vector3Tuple,
  },
  {
    id: 'bunk-starboard-b',
    position: [-7.55, FLOOR_Y + 2.1, 0.9] as Vector3Tuple,
  },
]
...
const nebulaPlanes = [
  {
    id: 'nebula-a',
    position: [0, FLOOR_Y + 5.8, -67] as Vector3Tuple,
    scale: [56, 20, 1] as Vector3Tuple,
    color: '#cc4f3c',
  },
  {
    id: 'nebula-b',
    position: [-16, FLOOR_Y + 4.0, -60] as Vector3Tuple,
    scale: [22, 10, 1] as Vector3Tuple,
    color: '#7a2746',
  },
  {
    id: 'nebula-c',
    position: [18, FLOOR_Y + 7.2, -58] as Vector3Tuple,
    scale: [26, 12, 1] as Vector3Tuple,
    color: '#ff9d6c',
  },
  {
    id: 'nebula-d',
    position: [0, FLOOR_Y + 3.4, 66] as Vector3Tuple,
    scale: [40, 18, 1] as Vector3Tuple,
    color: '#3e2b54',
  },
]
...
const upperDeckPanels: BoxFeatureConfig[] = [
  {
    id: 'command-gallery-deck',
    position: [0, SECOND_DECK_Y, -27.5],
    size: [14.5, SECOND_DECK_THICKNESS, 18],
  },
  {
    id: 'port-observation-deck',
    position: [-11.3, SECOND_DECK_Y, 8.4],
    size: [7.2, SECOND_DECK_THICKNESS, 46],
  },
  {
    id: 'starboard-archive-deck',
    position: [11.3, SECOND_DECK_Y, 10.8],
    size: [7.2, SECOND_DECK_THICKNESS, 42],
  },
  {
    id: 'aft-command-catwalk',
    position: [0, SECOND_DECK_Y, 32.4],
    size: [12.4, SECOND_DECK_THICKNESS, 22],
  },
]

const upperGuardSegments: BoxFeatureConfig[] = [
  {
    id: 'command-guard-port',
    position: [-7.3, SECOND_DECK_Y + 0.45, -27.5],
    size: [0.18, 0.9, 18],
  },
  {
    id: 'command-guard-starboard',
    position: [7.3, SECOND_DECK_Y + 0.45, -27.5],
    size: [0.18, 0.9, 18],
  },
  {
    id: 'port-gallery-outer-guard',
    position: [-14.85, SECOND_DECK_Y + 0.45, 8.4],
    size: [0.18, 0.9, 46],
  },
  {
    id: 'starboard-gallery-outer-guard',
    position: [14.85, SECOND_DECK_Y + 0.45, 10.8],
    size: [0.18, 0.9, 42],
  },
  {
    id: 'aft-catwalk-port-guard',
    position: [-6.3, SECOND_DECK_Y + 0.45, 32.4],
    size: [0.18, 0.9, 22],
  },
  {
    id: 'aft-catwalk-starboard-guard',
    position: [6.3, SECOND_DECK_Y + 0.45, 32.4],
    size: [0.18, 0.9, 22],
  },
  {
    id: 'aft-catwalk-forward-guard',
    position: [0, SECOND_DECK_Y + 0.45, 21.4],
    size: [12.4, 0.9, 0.18],
  },
  {
    id: 'aft-catwalk-aft-guard',
    position: [0, SECOND_DECK_Y + 0.45, 43.4],
    size: [12.4, 0.9, 0.18],
  },
]
...
const cargoCrates: BoxFeatureConfig[] = [
  {
    id: 'cargo-stack-a',
    position: [-2.8, FLOOR_Y + 0.95, 33.6],
    size: [3.2, 1.9, 3.4],
  },
  {
    id: 'cargo-stack-b',
    position: [3.8, FLOOR_Y + 1.35, 38.1],
    size: [2.6, 2.7, 2.8],
  },
  {
    id: 'cargo-stack-c',
    position: [0.2, FLOOR_Y + 0.7, 44.2],
    size: [4.6, 1.4, 2.6],
  },
  {
    id: 'cargo-stack-d',
    position: [-4.6, FLOOR_Y + 0.78, 28.4],
    size: [2.2, 1.56, 2.2],
  },
]
...
const messTables: BoxFeatureConfig[] = [
  {
    id: 'mess-table-a',
    position: [-11.4, FLOOR_Y + 0.72, 27.6],
    size: [2.8, 0.18, 1.2],
  },
  {
    id: 'mess-table-b',
    position: [-9.2, FLOOR_Y + 0.72, 33.2],
    size: [2.4, 0.18, 1.2],
  },
  {
    id: 'mess-counter',
    position: [-13.6, FLOOR_Y + 1.02, 29.8],
    size: [1.2, 2.04, 5.8],
  },
]
...
const serverBanks: BoxFeatureConfig[] = [
  {
    id: 'archive-bank-a',
    position: [9.4, SECOND_DECK_Y + 1.3, 1.6],
    size: [1.4, 2.6, 3.2],
  },
  {
    id: 'archive-bank-b',
    position: [13.2, SECOND_DECK_Y + 1.3, 1.6],
    size: [1.4, 2.6, 3.2],
  },
  {
    id: 'archive-bank-c',
    position: [9.4, SECOND_DECK_Y + 1.3, 13.8],
    size: [1.4, 2.6, 3.2],
  },
  {
    id: 'archive-bank-d',
    position: [13.2, SECOND_DECK_Y + 1.3, 13.8],
    size: [1.4, 2.6, 3.2],
  },
  {
    id: 'archive-bank-e',
    position: [11.3, SECOND_DECK_Y + 1.3, 24.0],
    size: [4.8, 2.6, 1.6],
  },
]
...
const medPods: BoxFeatureConfig[] = [
  {
    id: 'med-pod-a',
    position: [-12.8, FLOOR_Y + 1.02, 9.6],
    size: [1.2, 1.4, 3.6],
  },
  {
    id: 'med-pod-b',
    position: [-9.8, FLOOR_Y + 1.02, 9.6],
    size: [1.2, 1.4, 3.6],
  },
  {
    id: 'med-pod-c',
    position: [-12.8, FLOOR_Y + 1.02, 16.6],
    size: [1.2, 1.4, 3.6],
  },
  {
    id: 'med-pod-d',
    position: [-9.8, FLOOR_Y + 1.02, 16.6],
    size: [1.2, 1.4, 3.6],
  },
]
...
const chapelMonoliths: BoxFeatureConfig[] = [
  {
    id: 'chapel-monolith-a',
    position: [9.2, FLOOR_Y + 2.0, 12.8],
    size: [1.1, 4.0, 1.1],
  },
  {
    id: 'chapel-monolith-b',
    position: [12.4, FLOOR_Y + 2.2, 12.4],
    size: [1.1, 4.4, 1.1],
  },
  {
    id: 'chapel-monolith-c',
    position: [10.8, FLOOR_Y + 0.92, 18.4],
    size: [3.4, 1.84, 1.3],
  },
]
...
const brigBlocks: BoxFeatureConfig[] = [
  {
    id: 'brig-cell-a',
    position: [9.4, FLOOR_Y + 1.4, 30.0],
    size: [1.1, 2.8, 4.2],
  },
  {
    id: 'brig-cell-b',
    position: [13.0, FLOOR_Y + 1.4, 30.0],
    size: [1.1, 2.8, 4.2],
  },
  {
    id: 'brig-cell-c',
    position: [9.4, FLOOR_Y + 1.4, 37.6],
    size: [1.1, 2.8, 4.2],
  },
  {
    id: 'brig-cell-d',
    position: [13.0, FLOOR_Y + 1.4, 37.6],
    size: [1.1, 2.8, 4.2],
  },
  {
    id: 'brig-desk',
    position: [11.1, FLOOR_Y + 0.72, 42.0],
    size: [2.4, 1.44, 1.2],
  },
]
...
const supportColumns = [-12.8, -7.4, 7.4, 12.8].flatMap((x, columnIndex) => [
  {
    id: `support-${columnIndex}-a`,
    position: [x, FLOOR_Y + 3.0, -6] as Vector3Tuple,
    size: [0.7, 6.0, 0.7] as Vector3Tuple,
  },
  {
    id: `support-${columnIndex}-b`,
    position: [x, FLOOR_Y + 3.0, 21] as Vector3Tuple,
    size: [0.7, 6.0, 0.7] as Vector3Tuple,
  },
])
...
const roomLightClusters = [
  {
    id: 'medbay-light',
    position: [MEDBAY_CENTER[0], CEILING_Y - 1.1, MEDBAY_CENTER[2]],
    color: '#94eeff',
    intensity: 4.8,
    distance: 12,
  },
  {
    id: 'mess-light',
    position: [MESS_CENTER[0], CEILING_Y - 1.4, MESS_CENTER[2]],
    color: '#ffb469',
    intensity: 3.6,
    distance: 13,
  },
  {
    id: 'chapel-light',
    position: [CHAPEL_CENTER[0], CEILING_Y - 0.9, CHAPEL_CENTER[2]],
    color: '#b991ff',
    intensity: 4.2,
    distance: 12,
  },
  {
    id: 'brig-light',
    position: [BRIG_CENTER[0], CEILING_Y - 1.2, BRIG_CENTER[2]],
    color: '#ff6c7f',
    intensity: 3.2,
    distance: 10,
  },
  {
    id: 'archive-light',
    position: [
      ARCHIVE_GALLERY_CENTER[0],
      CEILING_Y - 1.6,
      ARCHIVE_GALLERY_CENTER[2],
    ],
    color: '#7dc8ff',
    intensity: 5.0,
    distance: 16,
  },
  {
    ...
    position: [
      OBSERVATION_GALLERY_CENTER[0],
      CEILING_Y - 1.6,
      OBSERVATION_GALLERY_CENTER[2],
    ],
    color: '#8adff5',
    intensity: 4.6,
    distance: 15,
  ...
  {
    id: 'cargo-light',
    position: [CARGO_HOLD_CENTER[0], CEILING_Y - 1.0, CARGO_HOLD_CENTER[2]],
    color: '#ff8c63',
    intensity: 5.2,
    distance: 19,
  },
...
const engineColumnColliders: CuboidColliderConfig[] = engineColumns.map(
  column => ({
...
const structuralWallColliders: CuboidColliderConfig[] = [
  ...hullWallSegments,
...
const upperDeckColliders: CuboidColliderConfig[] = upperDeckPanels.map(
  panel => ({
...
const upperGuardColliders: CuboidColliderConfig[] = upperGuardSegments.map(
  segment => ({
...
const chapelColliders: CuboidColliderConfig[] = chapelMonoliths.map(
  monolith => ({
...
const supportColumnColliders: CuboidColliderConfig[] = supportColumns.map(
  column => ({
    id: `${column.id}-collider`,
    position: column.position,
...
let levelTransitionHandler: {
  transitionToLevel?: (levelId: string) => boolean
} | null = null
...
function getMarkerSpriteIntensity(marker: InteractiveMarker) {
  return hoveredMarkerId === marker.id
    ? marker.intensity * 1.24
    : marker.intensity
}
...
function registerInteractiveMarker(
  ...
  interactionSystem.registerInteractiveObject({
    ...
    handlers: {
      ...
      onHover: (_data: InteractiveMarker, hovered: boolean) =>
        handleInteractiveHover(marker.id, hovered),
    },
  })
}
