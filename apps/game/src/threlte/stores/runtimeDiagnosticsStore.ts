...
const DEFAULT_DIAGNOSTICS: Record<string, DiagnosticRecord> = {
  ...
  worldLoading: {
    ...
    label: 'World Loading',
    level: 'idle',
    message: 'No world load is currently active.',
    updatedAt: 0,
  },
  worldBuilding: {
    key: 'worldBuilding',
    ...
    level: 'idle',
    message: 'No world build step is currently active.',
    updatedAt: 0,
  },
  worldPlayable: {
    key: 'worldPlayable',
    ...
    level: 'idle',
    message: 'Gameplay is waiting for the world lifecycle to finish.',
    updatedAt: 0,
  },
  worldUnloading: {
    key: 'worldUnloading',
    ...
    level: 'idle',
    message: 'No world unload is currently active.',
    updatedAt: 0,
  },
  worldError: {
    key: 'worldError',
    label: 'World Error',
    level: 'idle',
    message: 'No world lifecycle error is active.',
    updatedAt: 0,
  },
  player: {
    key: 'player',
