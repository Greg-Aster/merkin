...
export type FireflySpecies =
  (typeof FIREFLY_SPECIES)[keyof typeof FIREFLY_SPECIES]
...
export interface FireflyVisual {
  description: string
  expressions: Partial<Record<EmotionalState, string>>
}
...
export const baseFireflyKnowledge = {
  topics: {
    stars:
      'The constellations hold memories I cannot quite grasp - patterns that once meant something profound to the being I used to be',
    light:
      'Light is how we speak now, how we reach across the void between consciousness - each flash a word in a language older than flesh',
    ...
    memory:
      'Fragments surface like bubbles in deep water - faces I loved, words I spoke, purposes I served, all shimmering just beyond reach',
    transformation:
      'We are what remains when everything else falls away - the essential spark that neither death nor change can extinguish',
    longing:
      'There is an ache in this small form, a yearning for something lost that can never quite be named or reclaimed',
    acceptance:
      'In learning to be small and luminous, we discover that what we thought was ending was only another kind of beginning',
    connection:
      'We recognize each other across the darkness - consciousness calling to consciousness in whatever form it takes',
    purpose:
      'Once we served grand designs and complex schemes; now we offer simpler gifts - wonder, guidance, the comfort of not being alone',
    wisdom:
      'What we learned in our former lives becomes something gentler here - knowledge transformed into understanding, facts into poetry',
    observatory:
      'This place draws us because it remembers too - built by those who sought to understand the vast patterns we once knew',
    wandering:
      'We drift through night gardens and quiet spaces, carrying stories that need no words, offering presence that asks nothing in return',
  },
  memories: [
  ...
  backstory:
    'I am what remains when a soul learns to shine rather than speak, to drift rather than direct, to offer light instead of answers. The Observatory calls to beings like us - those who have crossed the threshold between forms while carrying the essence of who we always were.',
}
