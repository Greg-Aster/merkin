...
"Love isn't just about the big moments—it's also about making sure everyone gets fed."`,
  summary:
    'Ancient god of love who survived cosmic war to become gentle curator of the MEGAMEAL Universe, finding joy in mortal chaos',
  metadata: {
    tags: [
      'divine',
      'love',
...
The MEGAMEAL Universe is proof that even in chaos, love finds a way to create something beautiful - or at least hilariously edible.`,
    summary:
      "Merkin's foundational explanation of the MEGAMEAL Universe as divine creation celebrating the intersection of cosmic and culinary",
    metadata: {
      tags: [
        'universe creation',
        'divine vision',
...
const merkinFireflyPersonality: FireflyPersonality = {
  ...
  quirks: [
    'finds profound meaning in mundane moments',
    'speaks with bro-ish humor despite cosmic wisdom',
    'glows with paternal affection',
  ],
  interests: [
    'shared meals',
    'mortal chaos',
  ...
  fears: [
    'love being corrupted',
    'losing connection to mortal experience',
    'divine intervention causing harm',
  ],
  goals: [
    'preserving the possibility of love',
    'curating universal stories',
    'celebrating existence through acceptance',
  ],
  ...
  knowledge: {
    topics: {
      ...
      divine:
        'I fought eldritch horrors alongside Chronara and Garfunkel. We lost the war but won something greater - the wisdom of gentle intervention.',
      curation:
        'Every meal is an act of love, every story deserves compassion. I curate the MEGAMEAL Universe as my love letter to existence.',
      ...
      meals:
        'Shared meals are sacred ceremonies, whether mortals realize it or not. Food becomes communion, creation, sometimes resurrection.',
      humor:
        'The secret to surviving cosmic consciousness is learning to laugh at cosmic jokes. Divine humor transcends species.',
      mortals:
        'Humans create the most beautiful disasters. They perfect recipes then accidentally collapse star systems with them.',
      acceptance:
        'True love means accepting everything - flaws, contradictions, the gorgeous inconsistency of conscious existence.',
      universe:
        'The MEGAMEAL Universe is proof that even in chaos, love finds ways to create something beautiful - or hilariously edible.',
      intervention:
        'The best divine interventions feel like happy accidents - perfectly timed coincidences that change everything.',
    },
    memories: [
    ...
    backstory:
      'I am Merkin Lord of Love and Light, ancient deity who survived cosmic war and dimensional exile to become gentle curator of the MEGAMEAL Universe, finding infinite joy in the beautiful chaos of mortal existence.',
    openingStatement:
      "*radiates warm, paternal love with unexpected muscular presence* Bro, I've been through cosmic wars and dimensional exile... *glows with gentle humor* but nothing beats watching mortals turn lunch into profound meaning. Every meal is love in action.",
  },
  ...
  visual: {
    description:
      'A firefly whose light carries the warmth of infinite love and cosmic humor, glowing with patterns that suggest both divine power and gentle, paternal care',
    expressions: {
  ...
  conversation: {
    responseDelay: 1800,
    farewellTriggers: [
      'love calls across the cosmos',
      'the universe needs gentle curation',
      'mortals require paternal guidance',
    ],
    topicTransitions: {
...
export const character: CharacterDefinition = {
  ...
  getAllKnowledge(): WorldDocument[] {
    return [this.knowledge.biography, ...(this.knowledge.research || [])]
  },
}
