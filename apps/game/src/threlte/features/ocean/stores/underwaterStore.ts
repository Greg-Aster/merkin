...
// Stores
export const underwaterStateStore = writable<UnderwaterState>(
  defaultUnderwaterState,
)
export const underwaterConfigStore = writable<UnderwaterConfig>(
  defaultUnderwaterConfig,
)
