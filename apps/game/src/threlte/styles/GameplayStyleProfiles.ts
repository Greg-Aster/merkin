...
export const DEFAULT_SOLITUDE_ATMOSPHERE_PRESET: SolitudeAtmosphereProfileId = 'violet-dread'

export const solitudeAtmosphereProfileDefinitions: SolitudeAtmosphereProfileDefinition[] = [
  {
    id: 'violet-dread',
    label: 'Violet Dread',
    description: 'A hyper-saturated abyss of cyan signal-light and purple ruin haze.',
  ...
  },
  {
    id: 'signal-reef',
    label: 'Signal Reef',
    description: 'Dark flooded ruins lit by cyan reefs and magenta signal bleed.',
    stylePreset: 'surreal-site',
    settings: {
      style: {
        preset: 'surreal-site',
  ...
  },
  {
    id: 'orchid-void',
    label: 'Orchid Void',
    description: 'A darker surreal bloom where pink-violet anomalies pulse through the night.',
    stylePreset: 'surreal-site',
    settings: {
      style: {
        preset: 'surreal-site',
...
export function getSolitudeAtmosphereProfile(
  ...
  return solitudeAtmosphereProfileMap.get(id as SolitudeAtmosphereProfileId)
...
export function buildSolitudeRuntimeVisualStyle(
  ...
  const base = mergeRuntimeVisualStyle(DEFAULT_RUNTIME_VISUAL_STYLE, surrealSiteBaseRuntime)
  ...
  const runtime = mergeRuntimeVisualStyle(withProfile, {
    ...
    heightFog: settings?.style?.haze
      ? {
          ...
          density: settings.style.haze.density ?? withProfile.heightFog?.density,
          floor: settings.style.haze.floor ?? withProfile.heightFog?.floor,
          ceiling: settings.style.haze.ceiling ?? withProfile.heightFog?.ceiling,
          mistOpacity: settings.style.haze.mistOpacity ?? withProfile.heightFog?.mistOpacity,
          mistLayers: settings.style.haze.mistLayers ?? withProfile.heightFog?.mistLayers,
          mistHeight: settings.style.haze.mistHeight ?? withProfile.heightFog?.mistHeight,
          mistSpacing: settings.style.haze.mistSpacing ?? withProfile.heightFog?.mistSpacing,
          mistScale: settings.style.haze.mistScale ?? withProfile.heightFog?.mistScale,
          mistDriftSpeed: settings.style.haze.mistDriftSpeed ?? withProfile.heightFog?.mistDriftSpeed,
        }
      : undefined,
    colorGrading: settings?.style?.colorGrading
      ? {
          saturation: settings.style.colorGrading.saturation ?? withProfile.colorGrading.saturation,
          contrast: settings.style.colorGrading.contrast ?? withProfile.colorGrading.contrast,
          brightness: settings.style.colorGrading.brightness ?? withProfile.colorGrading.brightness,
          warmth: settings.style.colorGrading.warmth ?? withProfile.colorGrading.warmth,
        }
      : undefined,
    screenFx: settings?.style?.bloom
      ? {
          bloomIntensity: settings.style.bloom.intensity ?? withProfile.screenFx.bloomIntensity,
          bloomThreshold: settings.style.bloom.threshold ?? withProfile.screenFx.bloomThreshold,
        }
      : undefined,
  })
