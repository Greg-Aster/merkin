...
function assertRequiredPackageScripts(): void {
	const requiredScripts: Record<string, string> = {
		...
		"test:level-editor-selected-object-renderable-picker-contract":
			"tsx ./scripts/test-level-editor-selected-object-renderable-picker-contract.ts",
...
function assertWorkbenchSourceUsesConnectedRegions(): void {
	const requiredProgressSnippets = [
		...
		"Viewport bridge",
		"Content browser",
		"snap-aware normalized object-library drop placement exist",
		...
		"first inspector mesh/material picker slice implemented",
	...
	const requiredComponentSnippets = [
		...
		"No scene objects match",
		"<LevelEditorViewportBridgePanel",
		"buildLevelEditorViewportBridgeModel",
		"viewportBridgeViewMode",
		"viewportCameraMode",
		"viewportCameraZoomPercent",
		"viewportInteractionTool",
		"viewportTransformMode",
		"viewportTranslateSnapStep",
		"viewportRotateSnapStep",
		"viewportScaleSnapStep",
		"enabledViewportOverlayIds",
		"toggleViewportBridgeOverlay",
		"selectViewportCameraMode",
		"selectViewportCameraZoomPercent",
		"selectViewportInteractionTool",
		'tool === "place" && !viewportPlacementTarget?.canStage',
		...
		"Staged Operations",
		"Staged field edits",
		'aria-label="Queued authoring operations"',
		"summary.statusLabel",
		"summary.persistenceLabel",
		"Revert",
		...
		"stageViewportProjectedTransformDrag",
		...
		"authoringQueue.undoDepth",
		"authoringQueue.redoDepth",
		"authoringQueue.historyLimit",
		"Owner Write",
	...
	const requiredViewportBridgeSnippets = [
		...
		"model.interaction.activeTool",
		"model.interaction.renderedScenePickingEnabled",
		"interactionToolEnabled",
		"interactionToolReason",
		"Select a draft-ready object-library entry before using Place.",
		"viewportPickProjectedObjectFromNormalizedPoint",
		"model.interaction.projectedPickRadiusPercent",
		...
		"model.transformControls.rotationYawControl",
		"nudgeRotationYaw",
		"yawControl.valueDegrees.toFixed(1)",
	...
	for (const snippet of requiredWorkspaceUiSnippets) {
		assertIncludes(
			workspaceUi,
			snippet,
			`Expected workspace UI helper to preserve staged publish-readiness metadata ${JSON.stringify(snippet)}.`,
		);
	}
