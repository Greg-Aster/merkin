...
import PostFormattingToolbar from './PostFormattingToolbar.svelte'
import PostMarkdownHelp from './PostMarkdownHelp.svelte'
...
<div class="grid grid-cols-1 gap-8">
  ...
  <div class="{isFullscreen ? 'fixed inset-0 bg-white dark:bg-neutral-900 z-50 p-4 overflow-auto' : 'relative'} space-y-4 border-t border-neutral-200 dark:border-neutral-700 pt-6">
    ...
    {#if showMarkdownHelp}
      <PostMarkdownHelp onClose={() => showMarkdownHelp = false} />
    {/if}
