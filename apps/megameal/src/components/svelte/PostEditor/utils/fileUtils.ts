...
import type { FrontmatterData, Post } from './postUtils'
...
export async function convertDocxToMarkdown(
  ...
  try {
    ...
    if (typeof window === 'undefined') {
      throw new Error(
        'DOCX conversion is only available in browser environments',
      )
    }
