...
function generateBannerConfigContent() {
  ...
  const bannerConfigContent = `// Import type - use import type syntax to fix verbatimModuleSyntax error
import type { ImageMetadata } from 'astro'

// Import banner images
// These paths should match your actual banner image locations
import banner1 from '@assets/banner/0001'
import banner2 from '@assets/banner/0002'
import banner3 from '@assets/banner/0003'
import banner4 from '@assets/banner/0004'
import banner5 from '@assets/banner/0005'
import banner6 from '@assets/banner/0006'
import banner7 from '@assets/banner/0007'
