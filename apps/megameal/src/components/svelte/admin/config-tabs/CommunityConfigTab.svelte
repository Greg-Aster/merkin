...
import CommunityMessagingSections from './CommunityMessagingSections.svelte'
...
Discord Channels</h4>
    ...
    {:else if activeSection === 'contact' || activeSection === 'newsletter' || activeSection === 'events'}
      <CommunityMessagingSections
        {activeSection}
        {communityConfig}
        {notifyChanges}
        {editFeatureItem}
