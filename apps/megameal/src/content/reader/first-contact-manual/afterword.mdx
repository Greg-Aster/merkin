...
image: "/first-contact/afterword.webp"
backgroundImage: ""
...
<section className="not-prose fcmi-hero fcmi-window fcmi-tone-gray" aria-labelledby="afterword-heading">
    ...
    <div className="fcmi-frame fcmi-hero-frame">
      ...
      <div className="fcmi-hero-header">
        ...
        <div className="fcmi-hero-heading">
          <p className="fcmi-kicker">Corporate Afterword</p>
          <h1 id="afterword-heading" className="fcmi-hero-title">Why Business is Booming in an Empty Universe</h1>
        </div>
      </div>
      ...
      <p className="fcmi-hero-cite">— <cite>Bi-Smart Corporation Executive Research Committee</cite></p>
    </div>
  </div>
</section>
...
<section className="not-prose fcmi-section-panel fcmi-tone-purple fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--br" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-orange fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-green fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-blue fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-red fcmi-panel--strong fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-yellow fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-cyan fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<section className="not-prose fcmi-section-panel fcmi-tone-gray fcmi-afterword-panel">
<div className="fcmi-section-panel-inner fcmi-afterword-panel-inner">
<span className="fcmi-corner fcmi-corner--tl" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--tr" aria-hidden="true"></span>
<span className="fcmi-corner fcmi-corner--bl" aria-hidden="true"></span>
...
<span className="fcmi-corner fcmi-corner--br" aria-hidden="true"></span>
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    <div>
      <h4 className="text-orange-400 font-bold text-sm mb-3">Current Human Status</h4>
    ...
    <div>
      <h4 className="text-orange-400 font-bold text-sm mb-3">Projected Contact Timeline</h4>
...
<span className="fcmi-corner fcmi-corner--br" aria-hidden="true"></span>
  ...
  <h3 className="text-gray-300 font-bold text-sm mb-3">CORPORATE EXISTENTIAL ADVISORY</h3>
