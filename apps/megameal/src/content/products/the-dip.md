...
media:
  ...
  - type: image
    ...
    alt: "The Infinite Dip billboard"
    caption: "The Infinite Dip campaign image recovered from a W Corporation urban placement."
specifications:
  - label: "Classification"
    value: "Dipping sauce / family condiment / top-seller"
  - label: "Market Position"
    value: "Children's favorite in 7 of 9 measured districts"
  - label: "Consistency"
    value: "Thick, glossy, adhesive enough to concern professionals"
...
ingredients:
  ...
  - "Vegetable oil"
  - "Salt"
  - "Natural and artificial smoke flavor"
  - "Yeast extract"
  - "Paprika"
  - "Garlic powder"
  - "Onion powder"
  - "Color additives"
  - "Stabilizers"
  - "Proprietary appetite-support blend"
nutritionFacts:
  - label: "Serving Size"
    value: "2 tablespoons"
  - label: "Calories"
...
preWrittenReviews:
  ...
  - author: "District Lunch Coordinator"
    rating: 5
    date: "Weekly purchasing memo"
    comment: "Nothing moves units like The Dip. Students request it by name, teachers stop arguing, and inventory loss spikes every time we pretend to discontinue it. Operationally, it is a dream."
    verified: true
