...
<div className="flex flex-col md:flex-row gap-6 mb-8">
  <div className="md:w-1/3">
    <ImageWrapper src="/posts/timeline/redacted.png" alt="Corporate Media Division" class="w-full rounded-lg shadow-lg" imgClass="rounded-lg shadow-lg" loading="eager" />
  </div>
