...
<div className="flex flex-col md:flex-row gap-6 mb-8">
  <div className="md:w-1/3">
    <ImageWrapper src="/posts/timeline/redacted.png" alt="[CLASSIFIED]" class="w-full rounded-lg shadow-lg filter brightness-50 contrast-150" imgClass="rounded-lg shadow-lg filter brightness-50 contrast-150" loading="eager" />
