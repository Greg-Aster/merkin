---
title: "Dev Notes: First Contact Manual — World Bible & Voice Guide"
published: 2026-06-15
description: "Internal world bible for the First Contact Manual reader series: narrator voices, recurring statistics, named entities, and running gags to reuse instead of reinventing."
image: ""
showImageOnPost: false
tags: [Dev Notes, First Contact, World Bible, Site Updates]
...
- In-world setting: `timelineYear: 7.652e3` ("7,652"), the **"awakening-era"**, located in **"The Fringes of Known (and Mostly Hostile) Space"**.
...
- **"DON'T" as the cardinal rule**: the recurring imperative, usually styled as a bold red `DON'T`.
- **Bi-Smart Corporation**: the omnipresent, ethically-dubious "Kwik-E-Mart-esque" interstellar megacorp. Appears via:
