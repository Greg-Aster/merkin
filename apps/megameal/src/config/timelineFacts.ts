...
export const megaMealUniverseFacts: TimelineFact[] = [
  ...
  },
  {
    ...
    href: '/posts/timelines/boudin-noir-restaurant-review/',
  ...
  {
    type: 'advertisement',
    eyebrow: 'Universal Reader',
    headline: 'First Contact Manual',
    text: 'Open the field manual for interstellar travelers who need orientation before the next threshold opens.',
    ctaText: 'Open Manual',
  ...
  },
  {
    ...
    href: '/store/puppy-rescue-rations/',
  ...
  {
    type: 'advertisement',
    eyebrow: 'Emergency Rations',
    headline: 'Sad Snax™ — Now With Vitamin Xel-9',
    text: 'Red emergency paste for kits too honest to include hope. Tear carefully; serving may begin on your sleeve before reaching your mouth.',
    ctaText: 'Review Paste Facts',
    href: '/store/sad-snax/',
    sponsor: 'Emergency Nutrition Lab',
    finePrint:
      'No known expiration date. Alien vitamin claims use nonlocal reference tables.',
    theme: 'morale',
